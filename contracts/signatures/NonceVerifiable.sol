...
abstract contract NonceVerifiable is OwnableUpgradeable {
    ...
    event ContractNonceUpdated(uint256 _from, uint256 _to, address indexed _sender);
    event SignerNonceUpdated(uint256 _from, uint256 _to, address indexed _signer, address indexed _sender);
    event AssetNonceUpdated(
        uint256 _from,
        uint256 _to,
